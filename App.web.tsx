  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, minHeight: 0, width: "100%", maxWidth: 1320, alignSelf: "center", flexDirection: compact ? "column" : "row", alignItems: "center", justifyContent: compact ? "flex-start" : "center", gap: compact ? 8 : 54, paddingTop: compact ? 10 : 0, position: compact ? "relative" : "static" }}>
        <View style={{ width: compact ? "100%" : 520, height: visualHeight, position: compact ? "absolute" : "relative", top: compact ? (short ? 24 : 34) : undefined, flexShrink: 0, marginTop: compact ? 0 : 0, transform: [{ translateX: compact ? 0 : 42 }] }}>
        ...
        <View style={{ flex: compact ? 0 : 1, width: "100%", maxWidth: 620, gap: compact ? (short ? 7 : 10) : 18, justifyContent: "center", paddingBottom: compact ? 0 : 0, marginTop: compact ? 0 : 0, position: compact ? "absolute" : "static", left: compact ? 0 : undefined, right: compact ? 0 : undefined, bottom: compact ? (short ? 18 : 26) : undefined, transform: [{ translateY: 0 }] }}>
