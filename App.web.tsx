...
function Landing({ onStart }: { onStart: () => void }) {
  ...
  const visualHeight = compact
    ? Math.max(short ? 220 : 250, Math.min(short ? 285 : 330, height * (short ? 0.34 : 0.36)))
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={{
        ...
        paddingTop: compact ? 24 : 18,
        paddingBottom: compact ? 26 : 18,
        gap: compact ? 0 : 18,
        overflow: "hidden",
      }}
    >
      ...
      <View style={{ flex: 1, minHeight: 0, width: "100%", maxWidth: 1320, alignSelf: "center", flexDirection: compact ? "column" : "row", alignItems: "center", justifyContent: compact ? "space-between" : "center", gap: compact ? 0 : 54, paddingTop: compact ? 10 : 0 }}>
        <View style={{ width: compact ? "100%" : 520, height: visualHeight, position: "relative", flexShrink: 1, marginTop: 0, transform: [{ translateX: compact ? 8 : 42 }] }}>
