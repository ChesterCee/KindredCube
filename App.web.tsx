...
function Landing({ onStart }: { onStart: () => void }) {
  ...
  const visualHeight = compact
    ? Math.max(158, Math.min(short ? 215 : 265, height * (short ? 0.27 : 0.31)))
  ...
  const headingSize = compact
    ? Math.max(27, Math.min(short ? 34 : 41, width * 0.105))
  ...
  return (
    <ScrollView scrollEnabled={false} contentInsetAdjustmentBehavior="automatic" style={{ flex: 1, backgroundColor: C.cream }} contentContainerStyle={{ height: "100vh" as any, paddingHorizontal: compact ? 14 : 42, paddingTop: compact ? 7 : 18, paddingBottom: compact ? 9 : 18, gap: compact ? 4 : 18, overflow: "hidden" }}>
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", maxWidth: 1320, width: "100%", alignSelf: "center" }}>
        <Logo compact={compact} />
      </View>
      <View style={{ flex: 1, minHeight: 0, width: "100%", maxWidth: 1320, alignSelf: "center", flexDirection: compact ? "column" : "row", alignItems: "center", justifyContent: compact ? "flex-start" : "center", gap: compact ? 2 : 54 }}>
        ...
        <View style={{ flex: compact ? 0 : 1, width: "100%", maxWidth: 620, gap: compact ? (short ? 5 : 8) : 18, transform: [{ translateY: compact ? -8 : 0 }] }}>
